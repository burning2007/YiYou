                ...
                <ContentTemplate>
                    ...
                    <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="会诊医院数量" DataField="HospitalCount" ItemStyle-Width="200px" />
                            <%--<asp:BoundField HeaderText="会诊项目" DataField="project_name" />--%>
                            <asp:BoundField HeaderText="姓名" DataField="name" ItemStyle-Width="200px" />
                            <asp:BoundField HeaderText="性别" DataField="gendertext"  ItemStyle-Width="200px"/>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ActionHolder" runat="server">
    ...
    <script>
        function refreshGrid(type) {
            document.getElementById('ctl00_MainContent_hidFilter').value = type;
            var curSpanNavigation = '#ctl00_MainContent_';
            if (type == '' && type !='0') {
            ...
            $("#ctl00_MainContent_btnFilter").click();
        }
