<%@ Page Title="我的会诊" Language="C#" MasterPageFile="~/main.Master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="bg-main5 padding15">
        <div class="fg-main" style="padding-bottom: 10px;">
            <span class="large">
                <i class="icon-list"></i>&nbsp;我的会诊</span>
            <div class="place-right fg-main"><i class="icon-info"></i>&nbsp;会诊状态说明</div>
        </div>
        <div>
            <div style="padding-bottom: 5px;">
                <button class="bg-main fg-white">全部 <span class="badge bg-white fg-main">21</span></button>
                <button>未提交 <span class="badge bg-grayLight fg-white">1</span></button>
                <button>已提交未付款 <span class="badge bg-gray fg-white">0</span></button>
                <button>会诊进行中 <span class="badge bg-main fg-white">3</span></button>
            ...
            <table style="margin: 0;" class="table border">
                ...
                <tr>
                    ...
                    <td>北京</td>
                    <td>协和医院</td>
                    <td><span class="fg-main" style="border-bottom: dashed 1px #3C98CD;">提交</span>
                    </td>
                </tr>
                <tr>
                    <td>2015/04/09</td>
                    ...
                    <td>台湾</td>
                    <td>荣民医院</td>
                    <td><span class="fg-main" style="border-bottom: dashed 1px #3C98CD;">取消</span></td>
                </tr>
                <tr>
                    <td>2015/04/03</td>
                    <td>已审核</td>
                    ...
                    <td>新加坡</td>
                    <td>狮城医院</td>
                    <td><span class="fg-main" style="border-bottom: dashed 1px #3C98CD; cursor: pointer;" id="viewcontract">签约</span></td>
                </tr>
                <tr>
                    <td>2015/03/10</td>
                    <td>已签约</td>
                    ...
                    <td>北京</td>
                    <td>协和医院</td>
                    <td><span class="fg-main" style="border-bottom: dashed 1px #3C98CD;">付款</span></td>
                </tr>
                <tr>
                    <td>2015/01/27</td>
                    <td>会诊进行中</td>
                ...
                <tr>
                    ...
                    <td>新加坡</td>
                    <td>狮城医院</td>
                    <td><span class="fg-main" style="border-bottom: dashed 1px #3C98CD; cursor: pointer;" id="viewreport">查看结论</span></td>
                </tr>
                <tr>
                    <td>2014/12/26</td>
                    <td>已拒绝</td>
                ...
                <tr>
                    ...
                    <td>新加坡</td>
                    <td>狮城医院</td>
                    <td><span class="fg-main" style="border-bottom: dashed 1px #3C98CD;">查看结论</span></td>
                </tr>
                <tr>
                    <td>2014/04/28</td>
                    <td>已完成</td>
